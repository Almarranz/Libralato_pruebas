...
#     mu1 = -1. * umu1-8   # scale and shift to [-10., 10.)
    mu1 = -3+ (4*umu1-4/2)  # scale and shift to [-10., 10.)
    sigma1 = 4* (usigma1)   
    amp1 = 1 * uamp1 
    ...
    mu3 = -7+ (4*umu3-4/2) # scale and shift to [-3., 3.)
    sigma3 = 3.3*(usigma3)
    amp3 = uamp3
...
h=plt.hist(mul, bins= auto, color='darkblue', alpha = 0.6, density =True, histtype = 'stepfilled')
