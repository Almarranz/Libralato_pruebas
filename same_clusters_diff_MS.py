...
# for e in range(2):
    ...
    if len(repeat[0]>0):
        ...
        indices.append((all_np[e][-2],all_np[e][-1],new_all_np[repeat][0][-2],new_all_np[repeat][-1][-1]))
# %
...
np.savetxt(pruebas + '%scommon_clusters.txt'%(search),indices_np,fmt='%.0f',header = 'Group, cluster ---> Group, cluster') 
# %%
